                    ...
                    <data-table :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
                        <tbody>
                            <tr v-for = "(list, index) in teachers" :key="index" class="linkTable">
                                ...
                                <td class="text-grey">{{ list.account == null ? 'No' : 'Yes' }}</td>
                                <td>
                                    <div class="btn-group pull-right">
                                        ...
                                        <button type="button" v-if="list.deleted == 1" @click="restoreTeacher(list)" class="btn btn-default btn-sm">Restore</button>
                                        <button type="button" v-if="list.deleted == 0" @click="showdeleteTeacher(list)" class="btn btn-danger btn-sm">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                            <div class="btn-group">
                            <button type="button"  @click="saveTeacher"  class="btn btn-primary btn-lg">{{btn_cap}}</button>
